            ...
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-between p-4">
                    <div>
                        ...
                        <a href="{{ route('admin.puppies.index') }}" class="text-secondary text-decoration-none small fw-bold">Vedi tutti</a>
                    </div>
                    <div class="bg-light text-secondary rounded p-3 fs-3">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <a href="{{ route('admin.litters.create') }}" class="btn btn-success px-4 py-2 shadow-sm">
